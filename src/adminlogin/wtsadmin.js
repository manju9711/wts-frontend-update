  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      try {
        ...
        const roleResponse = await axios.get(`${process.env.REACT_APP_API_URL}/api/role/${role.id}`);
    ...
    <>
      ...
      <div className="flex justify-center items-center min-h-screen pt-20">
        <div className="w-full max-w-md bg-white shadow-md rounded p-6 relative">
          <h2 className="text-2xl font-bold pb-4 text-gray-800 text-center">Super Admin</h2>
